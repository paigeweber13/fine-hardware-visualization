...
// port usage
const std::string uops_dispatched_port_base_name = "UOPS_DISPATCHED_PORT_PORT_";
const std::string uops_executed_port_base_name = "UOPS_EXECUTED_PORT_PORT_";
...
// AMD
const uint32_t CPUFAMILY_ZEN_RYZEN            = 0x01;
const uint32_t CPUFAMILY_ZENPLUS_RYZEN        = 0x08;
const uint32_t CPUFAMILY_ZENPLUS_RYZEN2       = 0x18;
const uint32_t CPUFAMILY_ZEN2_RYZEN           = 0x31;
const uint32_t CPUFAMILY_ZEN2_RYZEN2          = 0x71;
const uint32_t CPUFAMILY_ZEN2_RYZEN3          = 0x60;
const uint32_t CPUFAMILY_ZEN3_RYZEN           = 0x01;
const uint32_t CPUFAMILY_ZEN3_RYZEN2          = 0x21;

// these are all the architectures with a mem counter
#define NUM_ARCH_MEM_COUNTER 30
const uint32_t ARCH_WITH_MEM_COUNTER[NUM_ARCH_MEM_COUNTER] = {
  ...
  CPUFAMILY_ATOM_DENVERTON, CPUFAMILY_ATOM_TREMONT,
  ...
  CPUFAMILY_ZEN_RYZEN, CPUFAMILY_ZENPLUS_RYZEN, CPUFAMILY_ZENPLUS_RYZEN2,
  CPUFAMILY_ZEN2_RYZEN, CPUFAMILY_ZEN2_RYZEN2, CPUFAMILY_ZEN2_RYZEN3,
  CPUFAMILY_ZEN3_RYZEN, CPUFAMILY_ZEN3_RYZEN2,
};
