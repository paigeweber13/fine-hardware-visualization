...
PERFGROUPS="CYCLE_ACTIVITY MEM_SP ICACHE TMA RECOVERY UOPS_EXEC L3 UOPS_RETIRE MEM FLOPS_DP L3CACHE CYCLE_STALLS FALSE_SHARE DIVIDE FLOPS_SP PORT_USAGE_TEST CLOCK ENERGY PORT_USAGE2 L2CACHE UOPS_ISSUE FLOPS_AVX TLB_DATA PORT_USAGE1 TLB_INSTR L2 MEM_DP BRANCH UOPS DATA"
